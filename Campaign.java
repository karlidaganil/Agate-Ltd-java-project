...
public class Campaign {
	...
	int adminstaffSayası=0;
	int creativestaffSayası=0;
	int accountmanagerSayası=0;
	...
	ArrayList<ConceptNotes> konseptNotları=new ArrayList<>();

	int kampanyaCalisanSayisi=0;
	int konseptNotlarıSayısı=0;
